...
1	55.64%	15,197.917	86.24s	    Yes	        Mar 23, 17:00
2	59.17%	16,159.501	81.11s	    Yes	        Mar 23, 17:41
'''
...
def _prepare_model(model):
    ...
    _UNCHECKPOINT_LAST_N = 0  # Qwen2.5-7B has 28 layers; uncheckpoint last N to save memory
